package com.kavalok.questCowboy
{
	...
	import questCowboy.McBell;
	
	public class Quest extends FindItemsQuestBase
	{

static public const ITEM:String = 'teleporter';
		...
		{
			if (hasItem(ITEM) && Global.charManager.isCitizen)
				return QuestStates.QUEST_TELEPORT;
