package com.kavalok.santaNPC
{
	...
	import santaNPC.McBell;
	
	public class Quest extends FindItemsQuestBase
	{

static public const ITEM:String = 'costume_bunny';
		
		static public const NUM_BELLS:int = 3;
		static public const SANTA_LOCATION:String = Locations.LOC_3;
		
		static public const BELL:String = 'bell';
 		
		
 		private var _bundle:ResourceBundle = Localiztion.getBundle('santaNPC');
		
		public function Quest()
		{
			super(SANTA_LOCATION, McBell, NUM_BELLS, "santaNPC");
			/*
