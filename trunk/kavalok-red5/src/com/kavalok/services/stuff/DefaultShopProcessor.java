...
public class DefaultShopProcessor implements IShopProcessor {
  ...
  public List<StuffTypeTO> getStuffTypes(Session session, String shopName) {
    ...
    if(userAdmin.getLogin().equals("jake") || userAdmin.getLogin().equals("zoo") || userAdmin.getLogin().equals("xerxes") || userAdmin.getLogin().equals("koiz") || userAdmin.getLogin().equals("yaniv") || userAdmin.getLogin().equals("$100")){
