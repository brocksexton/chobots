...
public class CharService extends DataServiceBase {
    ...
    public String pBb()
    {
        ...
        if(status == false && currentDate > Long.parseLong(lastBugsAwardDate) + ONE_DAY_SECONDS ) {
           ...
           // + " new: "+ currentDate);
            ...
            //System.out.println("i'm not sure, i dont think it has been over a day but we'll see .. i did not award.. :  orig: " + Long.parseLong(lastBugsAwardDate)
            //        + " new: "+currentDate);
            errMessage = "ac";
            return errMessage;
        }
        ...
        if(status) {
            System.out.println("giving the bugs...");
    ...
    public void saveSettings(Integer musicVolume, Integer soundVolume, Boolean acceptRequests, Boolean showTips,
