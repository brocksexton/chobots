...
public class AdyenRobotsNotificationServlet extends HttpServlet {
  ...
  public void init(ServletConfig config) throws ServletException {
    ...
    users.put("chobotsrock:chobotsadyen41032", ALLOWED);
    users.put("chobotsrockde:chobotsadyende41032", ALLOWED);
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    ...
    if (!allowUser(auth)) {
      ...
      try {
        AdyenUtil.processResultRequest(HttpUtil.normalizeRequestParameteres(req.getParameterMap()));
      } catch (Exception e) {
