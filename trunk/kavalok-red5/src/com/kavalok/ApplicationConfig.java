...
public class ApplicationConfig {
  ...
  private String emailsenderName = "Chobots.net";

  private String emailsenderAddress = "noreply@chobots.net";
  ...
  public ApplicationConfig(Properties applicationProperties) {
    ...
    this.emailsenderName = this.applicationProperties.getProperty("instance.emailsender.name", "Chobots.net Team");
