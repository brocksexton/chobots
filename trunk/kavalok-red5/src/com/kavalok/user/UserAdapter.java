...
public class UserAdapter {
    ...
    public void newPrivKey() {
        ...
        // String key2 = StringUtil.generateRandomString(5);

        privKey = key;
        executeCommand("GHzwPr35ZdfMm", key);
    ...
    public Boolean processKey(String key, Session session, String file) {
        if (!key.equals(privKey)) {
            ClientError adminLog = new ClientError("[HACKER ALERT]" + login + ": tried to hack item " + file, getConnection().getRemoteAddress(), getUserId(), true);
