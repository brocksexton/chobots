package com.kavalok.admin.news
{
	...
	public class NewsBase extends VBox
	{
		...
		private var newsDates:Array = new Array();
		private var newsImages:Array = new Array();
		private var newsInfo:Array = new Array();
		...
		{
				for each(var news:Object in result)
				{
					newsDates.push(news.dates.toString());
					newsInfo.push(news.info.toString());
					newsImages.push(news.image.toString());
					featuredChar.push(news.charName.toString());
					
				}
				featuredUserInput.text = featuredChar[0].toString();
				date1input.text = newsDates[0].toString();
				date2input.text = newsDates[1].toString();
				date3input.text = newsDates[2].toString();
				date4input.text = newsDates[3].toString();
