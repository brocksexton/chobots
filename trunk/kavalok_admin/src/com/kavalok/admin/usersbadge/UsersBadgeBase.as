package com.kavalok.admin.usersbadge
{
	...
	public class UsersBadgeBase extends VBox
	{
		...
		public function UsersBadgeBase()
		{
			super();
			filtersConfig.addItem(new FilterConfig("login", StringFilter, ""));
			filtersConfig.addItem(new FilterConfig("email", StringFilter, ""));
			filtersConfig.addItem(new FilterConfig("moderator", BooleanFilter, ""));
			filtersConfig.addItem(new FilterConfig("agent", BooleanFilter, ""));
			filtersConfig.addItem(new FilterConfig("staff", BooleanFilter, ""));
		}
