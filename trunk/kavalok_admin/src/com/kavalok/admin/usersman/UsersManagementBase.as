package com.kavalok.admin.usersman
{
	...
	public class UsersManagementBase extends VBox
	{
		...
		public function UsersManagementBase()
		{
			...
			filtersConfig.addItem(new FilterConfig("drawEnabled", BooleanFilter, false));
			...
			filtersConfig.addItem(new FilterConfig("journalist", BooleanFilter, true));
			filtersConfig.addItem(new FilterConfig("deleted", BooleanFilter, false));
		}
