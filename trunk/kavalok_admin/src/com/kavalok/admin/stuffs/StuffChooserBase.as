package com.kavalok.admin.stuffs 
{
	...
	public class StuffChooserBase extends Canvas
	{
		...
		[Bindable] public var doubleColorPicker : ColorPicker;
		[Bindable] public var doubleColorPickerLabel : Label;
		[Bindable] public var colorSec : int = 0xFFFFFF;
		...
		private function onGetStuffTypes(result:Array):void
		{
			...
			doubleColorPicker.visible = item && item.doubleColor;
			doubleColorPickerLabel.visible = item && item.doubleColor;
		}
		...
		protected function onShopItemChange():void
		{
			...
			doubleColorPicker.visible = item.doubleColor;
			doubleColorPickerLabel.visible = item.doubleColor;
		}
		
		protected function onColorChange():void
		{
			color = colorPicker.selectedColor;
			colorSec = doubleColorPicker.selectedColor;
			stuffItemView.setStuffType(item, colorPicker.selectedColor, doubleColorPicker.selectedColor);
		}
