...
package com.enefekt.tubeloc {
	...
	public class MovieSprite extends Sprite {
		...
		private function onComplete(event_p:Event):void {
			...
			receivingConnection.allowDomain("www.youtube.com");
			receivingConnection.allowInsecureDomain("www.youtube.com");
			...
			sendingConnection.allowDomain("www.youtube.com");
			sendingConnection.allowInsecureDomain("www.youtube.com");
		...
		private function initLoader():void {
			...
			var context : LoaderContext = new LoaderContext(false, null, SecurityDomain.currentDomain);
			tubeLocLoader.load(request)//, context);
		}
