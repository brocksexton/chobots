package com.kavalok.questSummer
{
	...
	import questSummer.McBell;
	
	public class Quest extends FindItemsQuestBase
	{
		static public const ITEM:String = 'surfboard';
		
		static public const NUM_BELLS:int = 1;
		static public const SANTA_LOCATION:String = Locations.LOC_BEACH;
		
		static public const BELL:String = 'McBell';
 		
		
 	//	private var _bundle:ResourceBundle = Localiztion.getBundle('questSanta2010');
		private var _bundle:ResourceBundle = Localiztion.getBundle('questSummer');
		
		public function Quest()
		{
			//super(SANTA_LOCATION, McBell, NUM_BELLS, "questSanta2010");
			super(SANTA_LOCATION, McBell, NUM_BELLS, "questSummer");
			/*
