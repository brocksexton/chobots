package com.kavalok.betaNPC
{
	...
	import betaNPC.McBell;
	
	public class Quest extends FindItemsQuestBase
	{

static public const ITEM:String = 'suit_space';
		
		static public const NUM_BELLS:int = 3;
		static public const SANTA_LOCATION:String = Locations.LOC_ROPE;
		
		static public const BELL:String = 'bell';
 		
		
 		private var _bundle:ResourceBundle = Localiztion.getBundle('betaNPC');
		
		public function Quest()
		{
			super(SANTA_LOCATION, McBell, NUM_BELLS, "betaNPC");
			/*
