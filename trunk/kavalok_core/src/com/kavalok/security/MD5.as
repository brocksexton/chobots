package com.kavalok.security
{
 	...
 	public class MD5
	{
		public static function hash(password:String):String
		{
			...
			//src.writeMultiByte(password,"unicode");
		...
		private static function core_md5(x:Array, len:uint):Array {
		  /* append padding */
		  x[len >> 5] |= 0x80 << ((len) % 32);
		  x[(((len + 64) >>> 9) << 4) + 14] = len;
		 ...
		 */
		private static function cmn(q:uint, a:uint, b:uint, x:uint, s:uint, t:uint):uint {
		  return rol(a + q + x + t, s) + b;
		}
		private static function ff(a:uint, b:uint, c:uint, d:uint, x:uint, s:uint, t:uint):uint {
		  return cmn((b & c) | ((~b) & d), a, b, x, s, t);
		}
		private static function gg(a:uint, b:uint, c:uint, d:uint, x:uint, s:uint, t:uint):uint {
		  return cmn((b & d) | (c & (~d)), a, b, x, s, t);
		}
		private static function hh(a:uint, b:uint, c:uint, d:uint, x:uint, s:uint, t:uint):uint {
		  return cmn(b ^ c ^ d, a, b, x, s, t);
		}
		private static function ii(a:uint, b:uint, c:uint, d:uint, x:uint, s:uint, t:uint):uint {
