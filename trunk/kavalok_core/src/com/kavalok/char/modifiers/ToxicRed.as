package com.kavalok.char.modifiers
{
	...
	public class ToxicRed extends CharModifierBase
	{
		...
		{
			_char.model.filters = [
				new GlowFilter(0xFF0000, 0.7, 10, 10, 1),
				new GlowFilter(0xFF0000, 1, 10, 10, 1.2, 1, true),
			];
			
			var transform:ColorTransform = new ColorTransform(1, 1, 1, 1, 100, 0, 0);
