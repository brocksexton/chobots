package com.kavalok.char.modifiers
{
	...
	public class FlyModifier extends CharModifierBase
	{
		static private const IDLE_INTERVAL:int = 1; //seconds
		...
		override protected function restore():void
		{
			...
			_timer.stop();
			_char.moveStartEvent.removeListenerIfHas(onStartMove);
			_char.moveCompleteEvent.removeListenerIfHas(onFinishMove);
