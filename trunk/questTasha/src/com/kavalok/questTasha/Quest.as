package com.kavalok.questTasha
{
	...
	import questTasha.McBell;
	
	public class Quest extends FindItemsQuestBase
	{
		static public const ITEM:String = 'flag_dave';
		
		static public const NUM_BELLS:int = 3;
		static public const SANTA_LOCATION:String = Locations.LOC_1;
