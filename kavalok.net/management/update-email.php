...
<font style="color:red;"><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span> You must enter a valid email address.</font>
<?php } ?>
<form method="post" action="" />
<div class="alert alert-warning">
An activation email will be sent to the new address to confirm your change. </div>
Enter your new email address
<input type="text" class="form-control" id="email" name="email" placeholder="" value=""> <br>
<input type="submit" name="submit" id="change" value="Update Email" style="margin-top:6px;width:100%;" class="btn btn-success">
</div>
</form>
</div>
</div>
