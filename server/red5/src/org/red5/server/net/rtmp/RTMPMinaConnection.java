  ...
  public boolean connect(IScope newScope, Object[] params) {
    ...
    try {
      ...
      if (client != null) {
        ...
        oName = JMXFactory.createObjectName("type", "RTMPMinaConnection", "connectionType", type, "host", hostStr,
            "port", port + "", "clientId", client.getId());
  ...
  public void write(Packet out) {
    ...
    if (ioSession != null) {
      ...
      if (time > 2000) {
        ...
        System.err.println("SLOW ioSession write time: " + (time) + " client host: " + ioSession.getRemoteAddress()
            + "\nMessage size: " + out.getHeader().getSize() + "\nMessage: " + out.getMessage());
      }
    }
  }
