...
public class SharedObjectService implements ISharedObjectService {
	...
	private HashMap<IScope, List<ISharedObjectServiceListener>> listeners = new HashMap<IScope, List<ISharedObjectServiceListener>>(); 
    ...
    public boolean createSharedObject(IScope scope, String name,
		...
		synchronized (scope) {
			...
			final SharedObjectScope soScope = new SharedObjectScope(scope, name,
