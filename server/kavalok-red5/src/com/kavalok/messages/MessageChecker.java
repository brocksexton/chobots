...
public class MessageChecker implements ISessionDependent {
  ...
  //Returns false if message is okay?
  public boolean checkMessage(User user, Long userId, String userLogin, String message, Boolean checkSpam, Boolean showInLog) {
      ...
      if (isSpam && checkSpam) {
          ...
          return true;
            ...
            new RemoteClient(session, user).sendCommand("NotificationCommand", "Sorry, we think you said a bad word. Try to avoid rude words!");
            if (showInLog)
