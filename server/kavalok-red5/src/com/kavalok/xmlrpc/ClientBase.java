...
public class ClientBase {
  ...
  private static final String URL_FORMAT = "http://%1$s:2834/%2$s/xmlrpc";
  ...
  protected void invokeInNewThread(final String rpcMethodName, Object[] parameters) {
    ...
    if(rpcMethodName.equals("RemoteServer.sendLocationCommand")){
      System.out.println("Well, we got this far.");
    }
