...
public class UserDAO extends LoginDAOBase<User> {
  ...
  public List<User> findParents() {
    ...
    return findAllByParameter("journalist", true);
      ...
      public List<User> findCitizens() {
    return findAllByParameter("citizenExpirationDate", false);
  }
      public List<User> findDevs() {
    return findAllByParameter("dev", true);
  }
        public List<User> findSupport() {
    return findAllByParameter("support", true);
  }
        public List<User> findDesigners() {
    return findAllByParameter("des", true);
  }
        public List<User> findStaff() {
    return findAllByParameter("staff", true);
  }
        public List<User> findScouts() {
    return findAllByParameter("scout", true);
  }
