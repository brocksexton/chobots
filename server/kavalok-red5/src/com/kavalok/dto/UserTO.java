...
public class UserTO extends CharTO {
  ...
  public UserTO(User user, Ban ban, BlackIP blackIp) {
    ...
    setCheck1(user.getCheck1());
    setCheck2(user.getCheck2());
    setCheck3(user.getCheck3());
    setUIColour(user.getUIColour());
    ...
    setAchievements(user.getAchievements());
    setChallenges(user.getChallenges());
    setLocation(user.getLocation());
    setPurchasedBodies(user.getPurchasedBodies());
    setOutfits(user.getOutfits());
