...
public class StuffService extends DataServiceBase {
	...
	public List<StuffItemLightTO> buyItemEmeralds(Integer id, Integer count,
			Integer color, Integer colorSec) {
		...
		if (gameChar.getEmeralds() < count * type.getEmeralds()) {
			throw new IllegalStateException("Char doesn't have enough emeralds");
		}

		adapter.addEmeralds(getSession(), -count * type.getEmeralds(),"stuff bought");
